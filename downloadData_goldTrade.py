...
# Tushare token ： 064e7ae816d18d54d2ea31177e930c4121ca4343568f89b7d7e44121


# import tushare as ts

# # 设置Tushare的Token
# ts.set_token('064e7ae816d18d54d2ea31177e930c4121ca4343568f89b7d7e44121')

# # 获取Pro版API
# pro = ts.pro_api()

# # 获取A股市场的股票数据（例如，沪深300指数的历史数据）
# df = pro.index_daily(ts_code='000300.SH', start_date='20210101', end_date='20220201')
